    ...
    <form onSubmit={handleSubmit} className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div className="sm:col-span-2">
          ...
          <input type="text" name="purpose" id="purpose" required defaultValue={ride.purpose} className="mt-1 block w-full rounded-md border dark:bg-zinc-950 dark:text-white border-zinc-300 dark:border-zinc-700 py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm" />
        </div>
        
        <div>
          <label htmlFor="driverId" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Řidič</label>
          <select name="driverId" id="driverId" required defaultValue={ride.driverId} className="mt-1 block w-full rounded-md border dark:bg-zinc-950 dark:text-white border-zinc-300 dark:border-zinc-700 py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm">
            {drivers.map(driver => (
        ...
        <div>
          ...
          <select name="vehicleId" id="vehicleId" required defaultValue={ride.vehicleId} className="mt-1 block w-full rounded-md border dark:bg-zinc-950 dark:text-white border-zinc-300 dark:border-zinc-700 py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="number" name="startKm" id="startKm" required defaultValue={ride.startKm} className="mt-1 block w-full rounded-md border dark:bg-zinc-950 dark:text-white border-zinc-300 dark:border-zinc-700 py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm" min="0" />
          </div>
          <div>
            <label htmlFor="endKm" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Konečný stav (km)</label>
            <input type="number" name="endKm" id="endKm" required defaultValue={ride.endKm} className="mt-1 block w-full rounded-md border dark:bg-zinc-950 dark:text-white border-zinc-300 dark:border-zinc-700 py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm" min="0" />
          </div>
        </div>

        <div className="sm:col-span-2">
          <label htmlFor="notes" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Poznámka (volitelné)</label>
          <textarea name="notes" id="notes" rows={3} defaultValue={ride.notes || ""} className="mt-1 block w-full rounded-md border dark:bg-zinc-950 dark:text-white border-zinc-300 dark:border-zinc-700 py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm"></textarea>
        </div>
      </div>
